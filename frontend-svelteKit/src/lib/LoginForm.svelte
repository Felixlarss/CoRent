<script lang="ts">
	import { confirmLogin, addMember, getMemberData } from '../lib/services/memberApi.ts';
...
<div class="flex flex-col items-center p-5">
	<form onsubmit={handleSubmit} class="sm:w-screem flex flex-col gap-3 p-5 md:w-1/4">
		<h1 class="flex text-3xl font-bold">{signUpForm ? 'Sign up' : 'Log in'}</h1>
		<input bind:value={member_name} placeholder="name" required />
